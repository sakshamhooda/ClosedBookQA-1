...
# Configuration
API_URL = os.getenv("API_URL", "http://localhost:8000")  # Will be updated for HF deployment

# Page configuration
st.set_page_config(
    page_title="Closed Book QA - HF Spaces",
    page_icon="📚",
    layout="wide",
...
# Header
st.markdown('<div class="main-header">📚 Closed Book QA - HF Spaces</div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <div style="text-align: center; color: grey; font-size: small;">
        ...
        <p><em>Powered by Streamlit + Hugging Face Spaces</em></p>
    </div>
    """,
    unsafe_allow_html=True
) 